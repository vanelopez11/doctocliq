...
const Home = ({ goTo }) => (
  <>
    <div className="step-header-spacer" style={{ display: 'none' }} />
    <div style={{ minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: '#f8f9fa' }}>
      <main style={{ flex: 1, width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <h2 style={{ textAlign: 'center', color: '#1e212a' }}>Proceso de registro Doctocliq</h2>
        <div
          style={{
            display: 'flex',
            flexWrap: 'wrap',
